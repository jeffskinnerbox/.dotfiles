...
"       curl -Sso ~/.dotfiles/.vim/autoload/pathogen.vim https://raw.githubusercontent.com/tpope/vim-pathogen/master/autoload/pathogen.vim
" Now you install all your plugins into a .dotfiles/.vim/bundle/<plugin-name> folder
"
...
" to install
"       cd ~/.dotfiles/.vim/bundle
"       git clone https://github.com/pearofducks/ansible-vim ~/.dotfiles/.vim/bundle/ansible-vim
...
if has("spell")
    ...
    set spellfile=$HOME/.dotfiles/pkg-vim/spell/en.utf-8.add
...
" Make sure ~/.dotfiles/.vim/backup has been created
