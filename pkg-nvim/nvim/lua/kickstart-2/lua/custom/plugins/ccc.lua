...
kickstart2/lua/custom/plugins/ccc.lua
  ...
  Description:
    ...
    generate any desired color. Also color highlights text color codes but
    these feature are redudent with 'norcalli/nvim-colorizer.lua' plugin.
  ...
  Usage:
    ...
    Keymapped Commands
     <leader>tcp                         - detects, displays, and replaces the color under the cursor
     <leader>tch                         - toggle color code highlight on & off BUT not nvim-colorizer.lua
...
-- ONLY 'norcalli/colorizer.nvim' plugin will color highlight the list below - named color codes
Black but not this --> black
White but not this --> white
Blue but not this --> blue
LightBlue but not this --> lightblue Lightblue
CornFlowerBlue but not this --> cornflowerblue
DarkBlue but not this --> Navy
LightSlateBlue but not this --> lightslateblue
Gray but not this --> gray
LightGray but not this --> lightgray
DarkGray but not this --> drakgray
Gray100 but not this --> gray100
Green LightGreen lightgreen DarkGreen 
Yellow LightYellow DarkYellow
Pink HotPink 
Magenta LightMagenta DarkMagenta
Red LightRed DarkRed
Cyan LightCyan DarkCyan
Lime but not this --> LightLime DarkLime
Fuchsia LightFuchia
Gold DarkGold
