...
--------------------------------------------------------------------------------
-- editor-advanced/nvim-web-devicons.lua
...
-- This is optional but recommended by nvim-tree/nvim-tree.lua.
...
if not status_ok then
  print("'configs/nvim-web-devicons.lua' module had an error")
  return
end
