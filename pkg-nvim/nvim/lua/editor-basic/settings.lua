...
-- If you're unsure what scope to use for a specific option :h option-nameis
-- your friend.
...
o.spelllang =  "en_us"                         -- use usa english spelling dictionary
...
vim.cmd[[highlight Search guifg=Black guibg=Pink]]  -- highlight search text in pink
...
-- command-line / cursor-line color & shape & movement
...
-- undo & history
o.history = 50                                 -- remember 50 items in command-line history
...
b.swapfile = false                             -- use a swap-file for the buffer
